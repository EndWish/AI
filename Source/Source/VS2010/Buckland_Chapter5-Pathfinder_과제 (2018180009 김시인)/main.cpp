...
const char* g_szApplicationName = "PathFinder (2018180009 ±è½ÃÀÎ), DF¹öÆ° -> Iterative Deeping Search ";
   ...
   static int CurrentSearchButton = 0;
    ...
    case WM_COMMAND:
    {
      ...
      case ID_BUTTON_DFS:
        ...
        g_Pathfinder->CreatePathIDS(); CurrentSearchButton = ID_BUTTON_DFS; break;
